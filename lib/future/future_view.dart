...
class _FutureViewState extends State<FutureView> {
  ...
  @override
  void initState() {
    // metodo que se ejecuta al inicializar el estado del widget.
    super.initState(); // Llama al metodo initState de la clase padre.
  ...
  Future<List<String>> cargarNombres() async {
    ...
    ); // Esperar 5 segundos para simular una carga.
    return [
